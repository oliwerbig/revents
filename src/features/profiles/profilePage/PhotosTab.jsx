...
import { Grid, Tab, Card, Image } from 'semantic-ui-react'
...
import { deleteFormFirebaseStorage } from '../../../app/firestore/firebaseService'
...
export default function PhotosTab({ profile, isCurrentUser }) {
	...
	async function handleDeletePhoto(photo, target) {
		...
		try {
			await deleteFormFirebaseStorage(photo.name)
